...
const ChiTietBaiViet: React.FC = () => {
  ...
  if (!post) return <PageContainer>Không tìm thấy bài viết!</PageContainer>;
      ...
      <Row gutter={[24, 24]}>
        <Col xs={24} lg={18}>
          <Card>
            ...
            {post.coverImage && (
              <img src={post.coverImage} alt={post.title} style={{ width: '100%', borderRadius: 8, marginBottom: 24, maxHeight: 400, objectFit: 'cover' }} />
            )}
