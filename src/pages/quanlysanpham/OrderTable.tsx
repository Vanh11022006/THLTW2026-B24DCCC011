...
import type { Order } from '../../models/quanlysanpham/types';
...
const OrderTable: React.FC = () => {
  ...
  const { updateQuantity } = useProduct();
  ...
  const handleStatusChange = (orderId: string, newStatus: Order['status']) => {
    ...
    // If completing the order, reduce inventory
    ...
    // If canceling the order, restore inventory
      ...
      render: (status: Order['status'], record) => (
        ...
        >
          <Select.Option value='Chờ xử lý'>
            <Tag color={getStatusColor('Chờ xử lý')}>Chờ xử lý</Tag>
          </Select.Option>
          <Select.Option value='Đang giao'>
            <Tag color={getStatusColor('Đang giao')}>Đang giao</Tag>
          </Select.Option>
          <Select.Option value='Hoàn thành'>
            <Tag color={getStatusColor('Hoàn thành')}>Hoàn thành</Tag>
          </Select.Option>
          <Select.Option value='Đã hủy'>
            <Tag color={getStatusColor('Đã hủy')}>Đã hủy</Tag>
          </Select.Option>
        </Select>
      ),
    },
        ...
        {selectedOrder && (
          <div>
            ...
            <Table
              ...
              dataSource={selectedOrder.products.map((p, index) => ({
                ...p,
                key: index,
              }))}
              pagination={false}
